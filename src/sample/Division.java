...
public class Division extends Statement implements Runnable {
    ...
    public ArrayList<Variable> detector(String line, ArrayList<Variable> variables) throws InvalidValueException {
        ...
        double result = calculate(index(find.substring(equal + 1, sum), variables), index(find.substring(sum + 1), variables));
